...
const Projects = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      id: 3,
      title: 'Robotic Arm',
      description: 'Designed a multi-axis robotic camera arm that meets key engineering targets for reach, payload, speed, and precision, while remaining lightweight, modular, and cost-effective for independent cinematographers. Design matches or beats industry-leading specifications, including: ~1 kg+ camera payload, while maintaining motion accuracy within ±0.5 mm, outperforming the original tolerance goals. I focused on designing the end effector in SolidWorks and specifying materials and components for the entire design to meet performance targets. I created a compact two-axis pan-tilt mechanism, selected lightweight aluminum and carbon-fiber elements to reduce inertia, and determined stepper motors and gearing capable of delivering appropriate torque for rapid, precise orientation of the camera. This was done while accounting for the forces necessary to support the system, and esetimated loads experienced during use.',
      images: [
        '/Solidworks 1.png',
        '/Solidworks 2.png',
